      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-8">
            ...
            <!-- User Favorite Restaurants Card -->
  ...
  methods: {
    async fetchUser(userId) {
      ...
      try {
        ...
        // response.data：isFollowed、profile(array)、
        const { data } = await userAPI.get({userId})
        const { profile, isFollowed } = data
        const { id, image, name, email, Comments, Followings, Followers, FavoritedRestaurants } = profile
        ...
        this.comments = profile.Comments.filter(comment => comment.Restaurant) //處理 comment.Restaurant可能有空值
